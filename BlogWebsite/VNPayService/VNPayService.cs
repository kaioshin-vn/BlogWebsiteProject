...
//		public string CreatePaymentUrl(HttpContext context, PaymentRequest paymentRequest)
//		{
...
//            //Để gửi số tiền thanh toán là 100,000 VND (một trăm nghìn VNĐ) thì merchant cần nhân thêm 100 lần (khử phần thập phân),
...
//        public PaymentTransaction PaymentExecute(IQueryCollection collections)
//        {
//            var vnpay = new VnPayLibrary();
