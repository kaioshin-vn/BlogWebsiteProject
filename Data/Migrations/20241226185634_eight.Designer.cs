...
namespace Data.Migrations
{
    ...
    [Migration("20241226185634_eight")]
    partial class eight
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Database.Table.Invoices", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Data.Database.Table.PostHideByRestricted", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("IdRestricted");

                    b.ToTable("PostHideByRestricted");
                });
            ...
            modelBuilder.Entity("Data.Database.Table.RegistrationAdvertisement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ContentAds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<Guid>("IdServiceAdvertis")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("TimeAccept")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("IdServiceAdvertis");

                    b.HasIndex("IdUser");

                    b.ToTable("RegistrationAdvertisements");
                });
            ...
            modelBuilder.Entity("Data.Database.Table.Service", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Data.Database.Table.ServiceAdvertisementPricing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ServiceAdvertisementPricing");
                });
            ...
            modelBuilder.Entity("Data.Database.Table.Invoices", b =>
                {
                    b.HasOne("Data.Database.Table.RegistrationAdvertisement", "RegistrationAdvertisement")
                        .WithMany("Invoices")
                    ...
                    b.Navigation("RegistrationAdvertisement");
            ...
            modelBuilder.Entity("Data.Database.Table.PostHideByRestricted", b =>
                {
                    ...
                    b.HasOne("Data.Database.Table.RestrictedWord", "RestrictedWord")
                        .WithMany()
                        .HasForeignKey("IdRestricted")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Post");

                    b.Navigation("RestrictedWord");
                });
            ...
            modelBuilder.Entity("Data.Database.Table.RegistrationAdvertisement", b =>
                {
                    b.HasOne("Data.Database.Table.ServiceAdvertisementPricing", "ServiceAdvertisementPricing")
                        .WithMany()
                        .HasForeignKey("IdServiceAdvertis")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ServiceAdvertisementPricing");
            ...
            modelBuilder.Entity("Data.Database.Table.ServiceAdvertisementPricing", b =>
                {
                    b.HasOne("Data.Database.Table.Service", "Service")
                        .WithMany()
